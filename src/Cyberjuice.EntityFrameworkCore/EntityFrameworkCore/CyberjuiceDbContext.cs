...
public class CyberjuiceDbContext :
    CompanyDbContextBase<CyberjuiceDbContext>,
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(CyberjuiceDbProperties.DbTablePrefix + "Companies", CyberjuiceDbProperties.DbSchema);
